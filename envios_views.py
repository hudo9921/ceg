            ...
            if selected_participant:
                ...
                for slot in slots:
                    ...
                    if slot.pacote_nacional:
                        if slot.pacote_nacional.status == PacoteNacional.Status.ENVIADO:
                ...
                for item in itens_individuais:
                    ...
                    is_item_paid = bool(item.preco_produto and item.preco_produto > 0)
                    ...
                    if item.pacote_nacional:
                        if item.pacote_nacional.status == PacoteNacional.Status.ENVIADO:
                            stats['enviados_count'] += 1
                        else:
                            stats['packed_count'] += 1
                    else:
...
class EmpacotarItensView(StaffRequiredMixin, View):
    ...
    def post(self, request):
        ...
        if not selected_uids:
            ...
            return redirect(f"/envios/?participant_id={participant.id}")
...
class MarcarPacoteEnviadoView(StaffRequiredMixin, View):
    ...
    def post(self, request, pacote_id):
        ...
        return redirect(f"/envios/?participant_id={pacote.participant_id}")
...
class DesempacotarItemView(StaffRequiredMixin, View):
    ...
    def post(self, request):
        ...
        return redirect(f"/envios/?participant_id={participant_id}")
